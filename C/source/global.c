...
int PIPE_MSG_DIGIT_NUM = 4;
int PIPE_MSG_BUFSIZE = 1024;
int SOCKET_BUFSIZE = 65536;
int SOCKET_MSG_DIGIT_NUM = 6;
int LISTENING_PORT = 5000;
int PIPE_FDS[2];
int TIME_SLOT = 2;      //seconds
int SIG_MSG_DIGIT_NUM = 2;
int SIG_MSG_BUFSIZE = 32;
int SIG_PIPE_FDS[2];
int IS_DAEMON=0;
