...
extern int SIG_MSG_DIGIT_NUM;
extern int SIG_MSG_BUFSIZE;
extern int PIPE_MSG_DIGIT_NUM;
extern int PIPE_MSG_BUFSIZE;
extern int TIME_SLOT;
extern int SOCKET_BUFSIZE;
...
extern int SOCKET_MSG_DIGIT_NUM;
